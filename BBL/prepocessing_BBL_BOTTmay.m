...
% Load the CSV file
%BOTTLE FILE
file = [path 'bottle_may19_onlygood.csv'];
ctd = readtable(file);
%%
% Specify the start and end datetime range
% Specify the start and end datetime range
start_datetime_tn1 = datetime('2019-05-12 21:44:00'); 
end_datetime_tn1 = datetime('2019-05-13 20:30:00');  
start_datetime_tn3 = datetime('2019-05-15 00:32:00'); 
end_datetime_tn3 = datetime('2019-05-15 21:45:00');
start_datetime_tn2 = datetime('2019-05-17 01:10:00'); 
end_datetime_tn2 = datetime('2019-05-17 21:45:00');
start_datetime_tn4 = datetime('2019-05-20 03:04:00'); 
end_datetime_tn4 = datetime('2019-05-21 01:39:00');
start_datetime_tn5 = datetime('2019-05-22 01:16:00'); 
end_datetime_tn5 = datetime('2019-05-23 10:22:00');
start_datetime_tn6 = datetime('2019-05-24 13:14:00'); 
end_datetime_tn6 = datetime('2019-05-25 03:20:00');
...
for i = 1:numel(transects)
    ...
    sub_data = df(df.station == station, {'pressure', 'temp', 'salinity', 'latitude', 'depth', 'no3', 'PON'});
...
save('/home/serena/Scrivania/Magistrale/thesis/data/TRANSECTS/2019/bbl_may19_bottle.mat', "transec")