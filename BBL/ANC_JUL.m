...
ctd = readtable('/home/serena/Scrivania/Magistrale/thesis/data/TRANSECTS/2019/bottle_jul19_onlygood.csv');
ctd.Cast_num = double(ctd.Cast_num);
ctd.Cast_num = round(ctd.Cast_num);
%%
% Specify the start and end datetime range
%JULY
start_datetime_tn1 = datetime('2019-07-06 00:07:00'); 
end_datetime_tn1 = datetime('2019-07-06 17:58:00');  
start_datetime_tn3 = datetime('2019-07-11 18:21:00'); 
end_datetime_tn3 = datetime('2019-07-12 13:51:00');
start_datetime_tn2 = datetime('2019-07-09 09:49:00'); 
end_datetime_tn2 = datetime('2019-07-09 20:50:00');
start_datetime_tn4 = datetime('2019-07-14 03:24:00'); 
end_datetime_tn4 = datetime('2019-07-14 20:00:00');

start_datetime_tn51 = datetime('2019-07-16 00:39:00'); 
end_datetime_tn51 = datetime('2019-07-16 13:18:00');
start_datetime_tn52 = datetime('2019-07-17 01:19:00'); 
end_datetime_tn52 = datetime('2019-07-17 04:11:00');

start_datetime_tn6 = datetime('2019-07-17 12:39:00'); 
end_datetime_tn6 = datetime('2019-07-18 05:45:00');
...
for i = 1:length(transects)
    ...
    for j = 1:length(station_id)
        ...
        for k = 1:length(var_names)
            ...
            % Sort by depth
            [profile_depth, idx] = sort(sub_data.depth);
...
%--------------------------------------------------------------------------
    ...
    % bottom = table2array(bottom); %change this + untill ATC fill the space close to the bottom
    ...
    ANC=cl_bblfcn(origRegX, origRegY, RegNo3, RegSigmatheta, avgsec, ...
        ...
        [0 2], [25.80 26.0 26.15 26.30 26.60]);
