...
cbar.set_label( label = "Temperature [$^\circ$C]", fontsize = 60, y = 0.5, labelpad = 30)
...
fig.suptitle("Monthly sea surface temperature (01-01-2003 / 31-12-2020)", fontsize = 60, y = 0.98)
