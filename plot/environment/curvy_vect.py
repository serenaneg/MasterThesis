...
# plot a quiver with axes.quiver() from that point. Make the quiver small enough so that only the arrow is visible
    ...
    lines2 = ax.contour(lon2d, lat2d, depth, levels = [200], colors='black', linewidths = 2, linestyles = '--')
...
cbar.set_label( label = "Velocity [m/s]", fontsize = 90, y = 0.5, labelpad = 40)
...
fig.suptitle("Monthly Sea Surface currents velocity (01-01-2003/31-12-2020)", fontsize = 100, y = 1.0)
