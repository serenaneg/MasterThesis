...
for i, ax in enumerate(axes.flat):
    ...
    ax.clabel(lines, fontsize=30, colors = 'black')
...
cbar.set_label( label = "Salinity [PSU]", fontsize = 60, y = 0.5, labelpad = 30)
...
fig.suptitle("Monthly Sea Surface salinity (01-01-2003 / 31-12-2020)", fontsize = 60, y = 0.98)
