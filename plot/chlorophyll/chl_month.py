...
# lat_range = slice(41.5, 37.5)   # for example, select between 40 and 50 degrees latitude
...
for i, ax in enumerate(axes.flat):
    ...
    #ax.clabel(lines2, inline=2, fontsize=35, colors = 'black')
...
cbar.set_label(label = "Chlorophyll [mg/m$^3$]", fontsize = 90, y = 0.5, labelpad = 30)
...
fig.suptitle("Monthly Chlorophyll-a concentration (01-01-2003 / 31-12-2020)", fontsize = 100, y = 0.97)
...
#%% Heat map
depths = (50, 75, 500, 1000, 2500, 3000)
proj = ccrs.PlateCarree()
...
lines = ax.contour(lons, lats, -depth, levels = depths, colors='black', linewidths = .75)
ax.clabel(lines, inline=2, fontsize=27, colors = 'black')
lines2 = ax.contour(lons, lats, -depth, levels = [200], colors='black', linewidths = 3)
...
ax.plot(x, y, transform = ccrs.PlateCarree(), color = 'magenta', linewidth =3)
